...
type FilterObservation struct {
	...
	FilterID *int64 `json:"filterId,omitempty" tf:"filter_id,omitempty"`
...
type FilterParameters struct {
	...
	// A comment to describe this IP filter.
	...
	// Expire date schedules the deaktivation of the filter. If none is set, the filter will be active until manual deactivation.
	// +kubebuilder:validation:Optional
	ExpireDate *string `json:"expireDate,omitempty" tf:"expire_date,omitempty"`

	// The Subdomain for the ip filter.
	// +kubebuilder:validation:Required
	SubdomainName *string `json:"subdomainName" tf:"subdomain_name,omitempty"`

	// Type of the IP filter.
	// +kubebuilder:validation:Required
	Type *string `json:"type" tf:"type,omitempty"`

	// The IP you want to whitelist or blacklist. By using CIDR notation on IPv4 IPs, you are able to define whole subnets.
	// +kubebuilder:validation:Required
