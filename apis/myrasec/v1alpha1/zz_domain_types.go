...
type DomainParameters struct {
	...
	// Auto update flag for the domain.
	...
	// Date until Myra will be automatically reactivated.
	// +kubebuilder:validation:Optional
	PausedUntil *string `json:"pausedUntil,omitempty" tf:"paused_until,omitempty"`
}
