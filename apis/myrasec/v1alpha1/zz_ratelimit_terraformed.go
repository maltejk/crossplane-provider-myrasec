...
func (tr *Ratelimit) GetObservation() (map[string]interface{}, error) {
...
func (tr *Ratelimit) SetObservation(obs map[string]interface{}) error {
...
func (tr *Ratelimit) GetParameters() (map[string]interface{}, error) {
...
func (tr *Ratelimit) SetParameters(params map[string]interface{}) error {
